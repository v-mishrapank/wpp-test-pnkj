...
variable "service_plan_id" {
  description = "ID of the App Service Plan (must be a FlexConsumption plan)."
  type        = string
}
...
variable "key_vault_name" {
  description = "Key Vault name for ingest config."
  type        = string
}
